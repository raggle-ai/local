...
export declare function githubCliPath(): string;
export declare function githubViewerLogin(): Promise<string>;
export declare function githubAuthenticatedAccounts(): Promise<GitHubAuthenticatedAccount[]>;
...
export declare function githubPullRequestsBrowserUrl(repository: GitHubRepository, authors?: string | string[]): string;
