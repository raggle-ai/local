...
import { repositoryCloneParentDirectory, repositoryRootPath } from "./add-project";
import { repoPrefixedProjectName, subpathProjectName } from "./folder-mapping";
...
} from "./standard-project-clone-index";
