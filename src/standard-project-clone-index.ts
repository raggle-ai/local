...
import { gitCurrentBranch, gitRemoteUrl, repositoryLookupKey } from "./git-repository";
import { sortLocalRepositoryCandidates, type LocalRepositoryCandidate } from "./local-repository-candidate";
